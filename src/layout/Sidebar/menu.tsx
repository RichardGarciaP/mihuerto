...
import { FaHouse, FaSunPlantWilt, FaUsers } from "react-icons/fa6";
...
export const MenuList: sidebarMenuType[] = [
  {
    ...
    Items: [
      ...
      },
      {
        ...
        badgetxt: "8",
        children: [
          { path: "/dashboard/groups", title: "Grupos", type: "link" },
        ],
      },
      {
        ...
        badgetxt: "8",
        children: [
          { path: "/dashboard/reports", title: "Crear informes", type: "link" },
        ],
      },
      {
        title: "Widgets",
